          ...
          <div className="about-text">
            <div className="row">
              <div className="col-md-6">
                <div className="row">
                  <i className="about-quote">“There is no sincerer love than the love of food.”</i>
                </div>
                <div className="row">
                  <i className="about-author">George Bernard Shaw</i>
                </div>
                <br />
              ...
              <div className="row">
                <div className="row">
                  <i className="about-quote">"Food is not just fuel. Food is about family, food is about community, food is about identity. And we nourish all those things when we eat well." </i>
                </div>
                <div className="row">
                  <i className="about-author">Michael Pollan</i>
                </div>
              </div>
              <br />
              <div className="row about-me">
                 Having lived around the globe in England, Israel, Australia and the U.S., it is clear to me that for each and every one of us, nutrition and lifestyle plays a fundamental role in our health outcomes. As in the case of a tree, wherever it is situated, its roots must be nurtured and nourished in order for its stem and branches to flourish, yielding true health. Our foundations mirror those of trees  as we too must tackle the cause of our ailments in order to be achieve true health. I learned that it is only by looking at the person as a whole we can address the root causes of imbalance, facilitate the body’s natural healing mechanisms/processes  (through diet and lifestyle) and in turn create positive changes that have lasting effects.
              </div>
              <br />
              <div className="row about-me">
                After earning my Master’s of Science in Nutrition at the National University of Natural Medicine  in Portland, Oregon, I moved to Los Angeles (LA), California where I decided to open up my own practice (focused on women’s health and wellbeing) to help those seeking nutritional support and looking to improve their health. Recognizing that females are often underrepresented in many areas of our society with healthcare and research as no exception, I decided to pursue my passion of utilizing nutrition and lifestyle as powerful tools for transforming health with a focus on motivating, educating and empowering my clients. Recognizing that each person should be considered on their own merit, distinctions should also be made between the health of women and men; both of which have completely different hormonal profiles and experience health in very different ways.
              </div>
              <br />
              <div className="row about-me">
